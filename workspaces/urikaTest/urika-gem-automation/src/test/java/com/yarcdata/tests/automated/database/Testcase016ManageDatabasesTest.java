...
public class Testcase016ManageDatabasesTest {
    ...
    public void Test () {
        ...
        MethodsLibrary.methodCreateNewDatabaseMultipleFilesSubmitCancel ();
        MethodsLibrary.methodCreateNewDatabaseMultipleFilesSubmitCancelValidate();
