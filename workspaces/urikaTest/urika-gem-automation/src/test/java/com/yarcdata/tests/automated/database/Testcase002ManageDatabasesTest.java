...
public class Testcase002ManageDatabasesTest {
    ...
    public void Test () {
        ...
        MethodsLibrary.methodSelectTabManageDatabases();

        MethodsLibrary.methodManageDatabaseLinkExists ();
        MethodsLibrary.methodManageDatabaseLinkValidation ();
        
        MethodsLibrary.methodClickManageDatabaseLink ();
        MethodsLibrary.methodClickManageDatabaseLinkValidation ();
