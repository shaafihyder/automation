...
public class TestcaseDeleteDataFileTest {
    ...
    public void Test () {
        ...
        System.out.println("\n@TestcaseDeleteDataFileTest @Test");
        ...
        MethodsLibrary.methodDeleteDataFile();
        FunctionsLibrary.functionCaptureStoreScreenshot (sTestcaseName);
        MethodsLibrary.methodQuitUrika();
    	System.out.println("@TestcaseDeleteDataFileTest: Successfully completed!\n");
