...
public class Testcase021SparqlQueryTest {
    ...
    //sUrikaMachine = "https://loki/urika/gem/";
    //sUrikaMachine = "https://comet1/urika/gem";
    @Test(groups = {"Smoke"})
    public void Test () {
        ...
        MethodsLibrary.methodNewUIChangesLimitQueryResultsReturned ();
        MethodsLibrary.methodNewUIChangesLimitQueryResultsReturnedValidate();
        
        MethodsLibrary.methodNewUIChangesLimitQuerySwitchingBetweenTabs ();
        MethodsLibrary.methodNewUIChangesLimitQuerySwitchingBetweenTabsValidate();

        MethodsLibrary.methodNewUIChangesLimitQueryIncorrectQuery ();
        MethodsLibrary.methodNewUIChangesLimitQueryIncorrectQueryValidate();
        
        MethodsLibrary.methodNewUIChangesLimitQueryCorrectResults ();
        MethodsLibrary.methodNewUIChangesLimitQueryCorrectResultsValidate();
        
        MethodsLibrary.methodNewUIChangesLimitQueryCorrectResultsOtherUser ();
        MethodsLibrary.methodNewUIChangesLimitQueryCorrectResultsOtherUserValidate();
        
        MethodsLibrary.methodNewUIChangesLimitQueryCorrectResultsUpdate ();
        MethodsLibrary.methodNewUIChangesLimitQueryCorrectResultsUpdateValidate();
        
        MethodsLibrary.methodNewUIChangesLimitQueryCorrectResultsUpdate21 ();
        MethodsLibrary.methodNewUIChangesLimitQueryCorrectResultsUpdate21Validate();
