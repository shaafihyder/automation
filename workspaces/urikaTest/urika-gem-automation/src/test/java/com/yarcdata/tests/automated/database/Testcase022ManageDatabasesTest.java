...
public class Testcase022ManageDatabasesTest {
    ...
    public void Test () {
        ...
        MethodsLibrary.methodCreateNewDatabaseMultipleFilesSubmitAddRulesPrevious ();
        MethodsLibrary.methodCreateNewDatabaseMultipleFilesSubmitAddRulesPreviousValidate();
