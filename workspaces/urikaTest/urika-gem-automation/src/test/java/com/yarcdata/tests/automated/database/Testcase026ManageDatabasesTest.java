...
public class Testcase026ManageDatabasesTest {
    ...
    public void Test () {
        ...
        MethodsLibrary.methodCreateNewDatabaseMultipleFilesSubmitAddRulesNextCancel ();
        MethodsLibrary.methodCreateNewDatabaseMultipleFilesSubmitAddRulesNextCancelValidate();
        
        MethodsLibrary.methodCreateNewDatabaseMultipleFilesSubmitAddRulesNextX ();
        MethodsLibrary.methodCreateNewDatabaseMultipleFilesSubmitAddRulesNextXValidate();
