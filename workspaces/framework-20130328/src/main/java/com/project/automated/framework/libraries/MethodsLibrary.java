...
public class MethodsLibrary
{
    ...
    @FindBy(id = "optionsRadios1") public WebElement objectPushbuttonSparqlQueryResultsInBrowser;
    ...
    @FindBy(xpath = "/html/body/div/div[3]/div[2]/div/div/div[2]/div[2]/div/div/div/div[2]/div/div[2]/div[2]/div[2]") public WebElement objectPanelSparqlQueryExecuteResults;
...
public WebDriver objectPushbuttonSparqlQueryResultsInBrowser_click (){
	   System.out.println("[" + this.getClass().getSimpleName() + "] " + new Exception().getStackTrace()[0].getMethodName() + " ()");
	   PageFactory.initElements(driver, this);
	   FunctionsLibrary.functionWaitForAnObject (2);
	   objectPushbuttonSparqlQueryResultsInBrowser.click();
	   FunctionsLibrary.functionWaitForAnObject (2);
	   return driver;
}
...
public WebDriver objectComboSparqlQueryRecordsPerPage100_click (){
	   System.out.println("[" + this.getClass().getSimpleName() + "] " + new Exception().getStackTrace()[0].getMethodName() + " ()");
	   PageFactory.initElements(driver, this);
	   FunctionsLibrary.functionWaitForAnObject (2);
...
public WebDriver objectComboSparqlQueryRecordsPerPage_click (){
	   System.out.println("[" + this.getClass().getSimpleName() + "] " + new Exception().getStackTrace()[0].getMethodName() + " ()");
	   PageFactory.initElements(driver, this);
	   FunctionsLibrary.functionWaitForAnObject (2);
