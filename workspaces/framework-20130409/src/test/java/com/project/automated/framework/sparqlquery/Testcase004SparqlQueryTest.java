...
public class Testcase004SparqlQueryTest implements GlobalLibrary{
...
public void Test (){
			...
			MethodsLibrary.objectBrowserWebApp_launch (GlobalLibrary.URIKAMACHINE); //c=chrome, e=explorer, f=firefox, h=htmlunit, s=safari
	       	...
	       	MethodsLibrary.objectTextfieldImportNameYourArtifact_enterdata (sSearchArtifact, lTimeOut);
	       	MethodsLibrary.objectTextfieldImportComment_enterdata (sSearchArtifact, lTimeOut);
	        ...
	        MethodsLibrary.objectPushbuttonNewDatabase_click (lTimeOut);
	       	MethodsLibrary.objectTextfieldNewDatabaseName_enterdata (sDatabase, lTimeOut);
	       	MethodsLibrary.objectPushbuttonNewDatabaseAddData_click (lTimeOut);
	       	MethodsLibrary.objectTextfieldNewDatabaseSearch_enterdata(sSearchArtifact, lTimeOut);
	       	...
	       	MethodsLibrary.objectTextfieldSparqlQueryNew_click (sQuery004, lTimeOut);
	       	...
	       	MethodsLibrary.objectComboSparqlQueryOutputFormat_selectxml (lTimeOut);
...
public void AfterTest ()  {
        	...
        	String sFile = "C:\\Users\\shyder\\Downloads\\TESTRESULT.xml";
        	...
        	FunctionsLibrary.functionCompareTwoXMLFiles ();
        	
        	//VALIDATION 1: XML FILE  
        	FunctionsLibrary.functionSearchStringInXMLFile(sFile, sVerifySPARQL1);
        	
        	//VALIDATION 2: XML FILE  
        	FunctionsLibrary.functionSearchStringInXMLFile(sFile, sVerifySPARQL2);
        	
        	//VALIDATION 3: XML FILE  
        	FunctionsLibrary.functionSearchStringInXMLFile(sFile, sVerifySPARQL3);
        	
        	//VALIDATION 4: XML FILE  
        	FunctionsLibrary.functionSearchStringInXMLFile(sFile, sVerifySPARQL4);
       
			MethodsLibrary.methodDisplayTextFile ();
	} 
}
