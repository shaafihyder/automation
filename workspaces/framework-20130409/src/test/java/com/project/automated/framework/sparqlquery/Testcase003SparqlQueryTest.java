...
public class Testcase003SparqlQueryTest implements GlobalLibrary{
...
public void Test (){
			...
			MethodsLibrary.objectBrowserWebApp_launch (GlobalLibrary.URIKAMACHINE); //c=chrome, e=explorer, f=firefox, h=htmlunit, s=safari
	       	...
	       	MethodsLibrary.objectTextfieldImportComment_enterdata (sArtifact, lTimeOut);
	        ...
	        MethodsLibrary.objectPushbuttonNewDatabase_click (lTimeOut);
	       	...
	       	MethodsLibrary.objectTextfieldSparqlQueryNew_click (sQuery003, lTimeOut);
