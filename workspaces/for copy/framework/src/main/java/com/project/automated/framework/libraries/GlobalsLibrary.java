...
public interface GlobalsLibrary {
	    ...
	    static public final String DESKTOP_HOME = FunctionsLibrary.functionGetPathDesktop();
	    static public final String LIBRARIES_HOME = FunctionsLibrary.functionGetPathLibraries();
	    static public final String TESTCASE_SUITE_HOME = FunctionsLibrary.functionGetPathTestcaseDirectories();
	    static public final String TEST_OUTPUT_HOME = FunctionsLibrary.functionGetPathTestOutputReports();
	    static public final String USER_HOME = FunctionsLibrary.functionGetPathUserDirectory();
	    static public final String JAVA_HOME = FunctionsLibrary.functionGetPathJavaInstallationDir ();
	    static public final String JAVA_CLASSPTH_HOME = FunctionsLibrary.functionGetPathJavaClasspath ();
	    static public final String OS_NAME_ARCHITECTURE = FunctionsLibrary.functionGetOSNameOSArchitecture();
	    static public final String USER_NAME = FunctionsLibrary.functionGetUsername ();
	    static public final String JAVA_VERSION = FunctionsLibrary.functionGetJavaVersion ();
	    
	    /*
	    static public final String sPathDesktop = FunctionsLibrary.functionGetPathDesktop();
	    static public final String sPathLibraries = FunctionsLibrary.functionGetPathLibraries();
	    static public final String sPathTestcaseDirs = FunctionsLibrary.functionGetPathTestcaseDirectories();
	    static public final String sPathTestOutputReports = FunctionsLibrary.functionGetPathTestOutputReports();
	    static public final String sPathUserDirectory = FunctionsLibrary.functionGetPathUserDirectory();
	    static public final String sPathJavaInstallationDir = FunctionsLibrary.functionGetPathJavaInstallationDir ();
	    static public final String sPathJavaClasspath = FunctionsLibrary.functionGetPathJavaClasspath ();
	    static public final String sOSNameOSArchitecture = FunctionsLibrary.functionGetOSNameOSArchitecture();
	    static public final String sUserName = FunctionsLibrary.functionGetUsername ();
	    static public final String sJavaVersion = FunctionsLibrary.functionGetJavaVersion ();
	    */
	    ...
	    //static public final String DATALIBRARY = FunctionsLibrary.functionGetPathLibraries()+"DataLibrary.xml";
	    ...
	    //static public final String DATALIBRARY = FunctionsLibrary.functionGetPathTestcaseDirectories()+"TestcaseDataLibrary.properties";
	    static public final String DATALIBRARY = "/Users/shyder/Desktop/Automation/workspaces/framework/src/test/resources/sparqlquery/sparqlquery.properties";
	    		//FunctionsLibrary.functionGetPathTestcaseDirectories()+"TestcaseDataLibrary.properties";
	    ...
	    static public final String URIKA_MACHINE = "http://nala1";
	    ...
	    //static public final String sQuery001 = FunctionsLibrary.functionReadDataLibraryProperties (DATALIBRARY, "sparqlquery.Testcase001SparqlQueryTest.sQuery");
	    //static public final String sVerifySPARQL1 =  FunctionsLibrary.functionReadDataLibraryProperties (DATALIBRARY, "sparqlquery.Testcase001SparqlQueryTest.sVerifySPARQL1"); 
	    //static public final String sVerifySPARQL2 =  FunctionsLibrary.functionReadDataLibraryProperties (DATALIBRARY, "sparqlquery.Testcase001SparqlQueryTest.sVerifySPARQL2");
	    //static public final String sVerifySPARQL3 =  FunctionsLibrary.functionReadDataLibraryProperties (DATALIBRARY, "sparqlquery.Testcase001SparqlQueryTest.sVerifySPARQL3");
	    //static public final String sVerifySPARQL4 =  FunctionsLibrary.functionReadDataLibraryProperties (DATALIBRARY, "sparqlquery.Testcase001SparqlQueryTest.sVerifySPARQL4");
