...
public class Testcase045SparqlQueryTest extends Superclass implements GlobalsLibrary{
...
public void Test (){
		    ...
		    String sQuery045 = FunctionsLibrary.functionReadDataLibraryProperties (DATALIBRARY, "sparqlquery.Testcase001SparqlQueryTest.sQuery");
