...
public class Testcase014SparqlQueryTest extends Superclass implements GlobalsLibrary{
...
public void Test (){
		    ...
		    String sQuery014 = FunctionsLibrary.functionReadDataLibraryProperties (DATALIBRARY, "sparqlquery.Testcase001SparqlQueryTest.sQuery");
