...
public class Testcase006SparqlQueryTest extends Superclass implements GlobalsLibrary{
...
public void Test (){
		    ...
		    String sQuery006 = FunctionsLibrary.functionReadDataLibraryProperties (DATALIBRARY, "sparqlquery.Testcase001SparqlQueryTest.sQuery");
