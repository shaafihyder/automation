...
public class Testcase033SparqlQueryTest extends Superclass implements GlobalsLibrary{
...
public void Test (){
		    ...
		    String sQuery033 = FunctionsLibrary.functionReadDataLibraryProperties (DATALIBRARY, "sparqlquery.Testcase001SparqlQueryTest.sQuery");
