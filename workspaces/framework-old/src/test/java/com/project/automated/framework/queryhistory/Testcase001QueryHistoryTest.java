...
public class Testcase001QueryHistoryTest implements GlobalLibrary{
	   ...
	   @Test(groups = {"sparqlquery"})
	    public void Test () {
	        ...
	        System.out.println ("@Testcase @Test sSearchText & sExecutedby" + sSearchText + " " + sExecutedby);
	        MethodsLibrary.methodFreeTextSearch_ExecutedBy (sSearchText, sExecutedby);
