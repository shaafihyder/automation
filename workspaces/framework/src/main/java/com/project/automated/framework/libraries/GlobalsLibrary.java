...
public interface GlobalsLibrary {
	    ...
	    String sFileSeparator = System.getProperty ("file.separator"); // '/' Linux or '\\' Windows
		...
		String sPathSrcTestResources = "src" + sFileSeparator + "test" + sFileSeparator + "resources";
		...
		static public final String HOME_RESOURCES = sPathSrcTestJava + sFileSeparator + sPathSrcTestResources;
		static public final String HOME_GLOBALSCONSTANTS = sPathSrcTestResources + sFileSeparator + "GlobalsConstants.xml";
	    ...
	    static public final String HOME_SPARQLQUERY_PROPS = GlobalsLibrary.HOME_RESOURCES + "sparqlquery" + sFileSeparator + "sparqlquery.properties";
	    static public final String HOME_BUILDDATABASE_PROPS = GlobalsLibrary.HOME_RESOURCES + "builddatabase" + sFileSeparator + "builddatabase.properties";
