	   ...
	   while (System.currentTimeMillis() < lEndTime) {
 	      ...
 	      if (objectPanelSparqlQueryBrowserResults.isDisplayed()) {
		          ...
		          if (sTestResults.contains(sSearchString) == true){
		        	  	...
		        	  	System.err.println  ("VALIDATION: Browser Result - Passed!");
		        		//System.
		        		FunctionsLibrary.functionLogResult ("[" + this.getClass().getSimpleName() + "] VALIDATION: Browser Result - Passed!", this.getClass().getSimpleName());
		        		
		    	  		}else {
		    	  			System.out.println("[" + this.getClass().getSimpleName() + "] " + "VALIDATION: Browser Results - Fail");
		    	  			System.err.println  ("VALIDATION: Browser Result - Failed!");
		    	    		//System.
		    	    		FunctionsLibrary.functionLogResult ("[" + this.getClass().getSimpleName() + "] VALIDATION: Browser Result - Failed!", this.getClass().getSimpleName());
		    	    		}
