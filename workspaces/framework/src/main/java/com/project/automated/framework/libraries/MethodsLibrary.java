...
public WebDriver objectBrowserWebApp_launchie (String sURL){
	   System.out.println("[" + this.getClass().getSimpleName() + "] " + new Exception().getStackTrace()[0].getMethodName() + " ()");
	   PageFactory.initElements(driver, this);
...
public WebDriver objectTextfieldLoginUsername_enterdata (String sUserName, long lTimeOutSeconds){
	   ...
	   Assert.assertEquals(true, bObjectExists);
...
//@FindBy(id = "login") public WebElement objectPushbuttonLoginSignIn;
public String methodVerifyLoginWebApp (){
	   System.out.println("[" + this.getClass().getSimpleName() + "] " + new Exception().getStackTrace()[0].getMethodName() + " ()");
	   PageFactory.initElements(driver, this);
	   ...
	   System.out.println("[" + this.getClass().getSimpleName() + "] " + new Exception().getStackTrace()[0].getMethodName() + " () Login Page Title: "+sLoginPageTitle);
	   
	   
return sLoginPageTitle;
}
...
@FindBy(xpath = "/html/body/div[2]/div/div/div/ul/li[2]/a") public WebElement objectPushbuttonTabDashboard;
public WebDriver objectPushbuttonTabDashboard_click (long lTimeOutSeconds){
	   ...
	   while (System.currentTimeMillis() < lEndTime) {
		   		...
		   		objectPushbuttonTabDashboard = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/ul/li[2]/a"));
...
@FindBy(xpath = "/html/body/div[2]/div/div/div/ul/li[7]/a") public WebElement objectPushbuttonTabManageData;
public WebDriver objectPushbuttonTabManageData_click (long lTimeOutSeconds){
	   ...
	   while (System.currentTimeMillis() < lEndTime) {
		    	objectPushbuttonTabManageData = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/ul/li[7]/a"));
...
@FindBy(xpath = "/html/body/div[2]/div/div/div/ul/li[6]/a") public WebElement objectPushButtonTabManageDatabase;
public WebDriver objectPushButtonTabManageDatabase_click (long lTimeOutSeconds){
	   ...
	   while (System.currentTimeMillis() < lEndTime) {
		   objectPushButtonTabManageDatabase = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/ul/li[6]/a"));
...
@FindBy(xpath = "/html/body/div[2]/div/div[2]/div[9]/div[2]/form/div/div/div/div[2]/div/label/input") public WebElement objectTextfieldNewDatabaseSearch;
public WebDriver objectTextfieldNewDatabaseSearch_enterdata (String sDatabaseName, long lTimeOutSeconds){
	   ...
	   while (System.currentTimeMillis() < lEndTime) {
		   objectTextfieldNewDatabaseSearch = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div[9]/div[2]/form/div/div/div/div[2]/div/label/input"));
...
@FindBy(xpath = "/html/body/div[2]/div/div[2]/div[9]/div[2]/form/div/div/table/tbody/tr/td/label/input") public WebElement objectCheckboxNewDatabase;
public WebDriver objectCheckboxNewDatabase_check (long lTimeOutSeconds){
	   ...
	   while (System.currentTimeMillis() < lEndTime) {
		   objectCheckboxNewDatabase = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div[9]/div[2]/form/div/div/table/tbody/tr/td/label/input"));
...
@FindBy(xpath = "/html/body/div[2]/div/div/div/ul/li[14]/a") public WebElement objectPushbuttonSparqlQuery;
public WebDriver objectPushbuttonSparqlQuery_click (long lTimeOutSeconds){
	   ...
	   while (System.currentTimeMillis() < lEndTime) {
 		     objectPushbuttonSparqlQuery = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/ul/li[14]/a"));
...
@FindBy(xpath = "/html/body/div[2]/div/div[2]/div/div/div[2]/div/div[2]/div/div[3]") public WebElement objectTextfieldSparqlQueryNew;
public WebDriver objectTextfieldSparqlQueryNew_click (String sQuery, long lTimeOutSeconds){
	   ...
	   while (System.currentTimeMillis() < lEndTime) {
		     objectTextfieldSparqlQueryNew = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div/div[2]/div/div[2]/div/div[3]"));
    	     if (objectTextfieldSparqlQueryNew.isDisplayed()) {
    		     ...
    		     WebElement elementCodeMirrorTextField = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div/div[2]/div/div[2]/div/div[3]"));
...
public WebDriver methodDisplayTestReport (String sTestReport){
	
	String sPrefix = "file://";
	sTestReport = sPrefix + sTestReport;
	driver = new FirefoxDriver(); 
	driver.get(sTestReport);
	driver.manage().window().maximize();
...
public WebDriver methodVerify_BrowserResultsValidation (String sSearchString, long lTimeOutSeconds){
	   ...
	   while (System.currentTimeMillis() < lEndTime) {
 	      ...
 	      if (objectPanelSparqlQueryBrowserResults.isDisplayed()) {
		          ...
		          if (sTestResults.contains(sSearchString) == true){
		        	  	System.out.println("[" + this.getClass().getSimpleName() + "] " + "VALIDATION: Browser Results - Pass");
		        	  	
		        	  	Assert.assertEquals(true, sTestResults.contains(sSearchString));
		        	  	
		        	  	
		        	  	System.out.println  ("VALIDATION: Browser Result - Passed!");
		        		
		    	  		}else {
		    	  			System.err.println("[" + this.getClass().getSimpleName() + "] " + "VALIDATION: Browser Results - Fail");
		    	  			}
...
public String methodGetBrowserNameVersion (){
	String sReturn = "";
	String sBrowserName = "";
	String sBrowserVersion = "";
	
	WebDriver driver = new FirefoxDriver ();
	driver.get("http://www.yarcdata.com");
	Capabilities caps = ((RemoteWebDriver) driver).getCapabilities ();
	
	sBrowserName = caps.getBrowserName();
	sBrowserVersion = caps.getVersion();
	driver.close();
	driver.quit();
	sReturn = sBrowserName + " " + sBrowserVersion;
	//System.out.println("\n[" + this.getClass().getSimpleName() + "] Browser Name and Version => "+sReturn);
	 try {
   	  Thread.sleep(2000);} 
     catch (InterruptedException e) {
   	  e.printStackTrace();  }
